...
set C_modelArgList {
	{ input_V int 14 regular {array 576 { 1 3 } 1 1 }  }
	{ output_V int 14 regular {array 576 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "input_V", "interface" : "memory", "bitwidth" : 14, "direction" : "READONLY"} , 
 	{ "Name" : "output_V", "interface" : "memory", "bitwidth" : 14, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ output_V_d0 sc_out sc_lv 14 signal 1 } 
}
set NewPortList {[ 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1665", "Max" : "1665"}
	, {"Name" : "Interval", "Min" : "1665", "Max" : "1665"}
]}
...
set Spec2ImplPortList { 
	...
	output_V { ap_memory {  { output_V_address0 mem_address 1 10 }  { output_V_ce0 mem_ce 1 1 }  { output_V_we0 mem_we 1 1 }  { output_V_d0 mem_din 1 14 } } }
}
