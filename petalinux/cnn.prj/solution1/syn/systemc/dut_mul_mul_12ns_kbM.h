...
#ifndef __dut_mul_mul_12ns_kbM__HH__
#define __dut_mul_mul_12ns_kbM__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_mul_mul_12ns_kbM) {
    ...
    SC_CTOR(dut_mul_mul_12ns_kbM):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
