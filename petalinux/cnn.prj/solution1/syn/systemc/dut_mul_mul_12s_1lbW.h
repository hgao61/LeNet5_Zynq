...
#ifndef __dut_mul_mul_12s_1lbW__HH__
#define __dut_mul_mul_12s_1lbW__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_mul_mul_12s_1lbW) {
    ...
    SC_CTOR(dut_mul_mul_12s_1lbW):  ACMP_smul_su_U ("ACMP_smul_su_U") {
