...
#ifndef __dut_mul_mul_14s_1pcA__HH__
#define __dut_mul_mul_14s_1pcA__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_mul_mul_14s_1pcA) {
    ...
    SC_CTOR(dut_mul_mul_14s_1pcA):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
