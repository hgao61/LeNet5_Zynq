...
#ifndef __dut_uitofp_32ns_3Aem__HH__
#define __dut_uitofp_32ns_3Aem__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_uitofp_32ns_3Aem) {
    ...
    SC_CTOR(dut_uitofp_32ns_3Aem):  ACMP_uitofp_U ("ACMP_uitofp_U") {
