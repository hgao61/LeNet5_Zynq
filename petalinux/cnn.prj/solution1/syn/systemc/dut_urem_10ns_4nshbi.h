...
#ifndef __dut_urem_10ns_4nshbi__HH__
#define __dut_urem_10ns_4nshbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_urem_10ns_4nshbi) {
    ...
    SC_CTOR(dut_urem_10ns_4nshbi):  ACMP_urem_seq_U ("ACMP_urem_seq_U") {
