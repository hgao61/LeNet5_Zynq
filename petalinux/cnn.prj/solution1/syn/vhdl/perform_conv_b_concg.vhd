...
entity perform_conv_b_concg_rom is 
    generic(
             dwidth     : integer := 9; 
             awidth     : integer := 6; 
             mem_size    : integer := 64
...
architecture rtl of perform_conv_b_concg_rom is 
...
entity perform_conv_b_concg is
    generic (
        DataWidth : INTEGER := 9;
...
architecture arch of perform_conv_b_concg is
    component perform_conv_b_concg_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    perform_conv_b_concg_rom_U :  component perform_conv_b_concg_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
