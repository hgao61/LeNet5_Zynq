...
set rc [catch {
  ...
  add_files -quiet /media/adamsmith/Storage/SynologyDrive/ece5775_lab4-master/ecelinux/zedboard_project/xillybus/vivado/xillydemo.runs/synth_1/xillydemo.dcp
...
set rc [catch {
  ...
  route_design 
  set src_rc [catch { 
    puts "source /media/adamsmith/Storage/SynologyDrive/ece5775_lab4-master/ecelinux/zedboard_project/vivado-essentials/showstopper.tcl"
  ...
  if {$src_rc} { 
    ...
    send_msg_id runtcl-2 error "sourcing script /media/adamsmith/Storage/SynologyDrive/ece5775_lab4-master/ecelinux/zedboard_project/vivado-essentials/showstopper.tcl failed"
    return -code error
  }
